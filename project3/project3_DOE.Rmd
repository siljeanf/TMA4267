...
Before starting the experiments I have tested the webpage-measurement of the download speed. It seems to be a bit unstable, and sometimes it gives results that are very off when I cannot explain why. Therefore I decide to do two repititions during each experiment, and then have two observations of the response per row, which I will find the mean for. Alternativly I could have performed two replicates where the measurement are taken during identical but different experimental runs, often with randomization. Repetitions is easier and as I expect it will contribute to decrease the effect of the unexplainable unstability of the instrument, it is preferable.
...
From the print-out of the estimated effects we notice that the two factors *C* and *CD* clearly are biggest in absolute value, ande therefore indicating a higher significance. Usually, the three-factor and four-factor interactions are small and therefore negligeble. We can illustrate this through a interaction plot. 
